...
public class BluetoothUtils {
    ...
    /**接收到新的信息*/
    private static final int RECEIVE_NEW_MSG = CONNECT_CLIENT_ERROR+ 1;
        ...
        public void handleMessage(Message msg) {
                ...
                switch (msg.what){
                    case RECEIVE_NEW_MSG:
                        intent.setAction(BluetoothConstant.ACTION_RECEIVED_NEW_MSG);
                        intent.putExtra("msg",(String)msg.obj);

                    case WAITING_FOR_CLIENT:
                        //初始化服务器完成
                        intent.setAction(BluetoothConstant.ACTION_INIT_COMPLETE);
                        break;
                    ...
                    case CONNECTED_SERVER:
                        ...
                        intent.setAction(BluetoothConstant.ACTION_CONNECTED_SERVER);
                        break;
...
//                socketMap.put(BluetoothConstant.bluetoothAddress, socket);
                socketMap.put(remoteAddress, socket);
...
//                    remoteDeviceMap.put(socket.getRemoteDevice().getAddress(),socket.getRemoteDevice());
    ...
    //发送数据
    public void sendMessageHandle(String msg, String remoteDeviceAddress) {
        BluetoothSocket socket = socketMap.get(remoteDeviceAddress);
        if (socket == null) {
...
//                    }
                    ...
                    try {
//                        BluetoothConstant.isOpen = false;
                        closeConnection(remoteDeviceAddress);
                        mmInStream.close();
                    } catch (IOException e1) {
                        e1.printStackTrace();
...
//    public void init(String remoteAddress, BluetoothConstant.DeviceType deviceType) {
//        BluetoothConstant.deviceType = deviceType;
//        BluetoothConstant.bluetoothAddress = remoteAddress;
//
////        if (BluetoothConstant.isOpen) {
////            Toast.makeText(mContext, "连接已经打开，可以通信。如果要再建立连接，请先断开！", Toast.LENGTH_SHORT).show();
////            return;
////        }
//        if (BluetoothConstant.deviceType == BluetoothConstant.DeviceType.CLIENT) {
...
//                }
////                BluetoothConstant.isOpen = true;
//            } else {
//                Toast.makeText(mContext, "address is null !", Toast.LENGTH_SHORT).show();
//            }
//        } else if (BluetoothConstant.deviceType == BluetoothConstant.DeviceType.SERVER) {
...
//        }
//        BluetoothConstant.isOpen = false;
//        BluetoothConstant.deviceType = BluetoothConstant.DeviceType.NONE;
